...
namespace ImGui {
	...
	void Image(gl::LargeTexture*, const ImVec2& size, const ImVec4& tint_col = ImVec4(1, 1, 1, 1), const ImVec4& border_col = ImVec4(0, 0, 0, 0));
	...
	// The following functions add functionalyity to "Drawlist"
	void AddImage(ImDrawList* dl, gl::LargeTexture* tex, const ImVec2 top_left, const ImVec2& size, const ImVec4& tint_col);
